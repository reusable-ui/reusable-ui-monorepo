...
export type DefaultCommonColors = ReturnType<typeof getDefaultCommonColors>
 ...
 */
const getDefaultRootColors = (commonColors: DefaultCommonColors) => ({
    /**
...
export type DefaultRootColors = ReturnType<typeof getDefaultRootColors>
 ...
 */
const getDefaultBaseColors = (rootColors: DefaultRootColors) => ({
    /**
 ...
 */
const getDefaultMildColors = (rootColors: DefaultRootColors) => ({
    /**
 ...
 */
const getDefaultFlipColors = (rootColors: DefaultRootColors) => ({
    /**
 ...
 */
const getDefaultTextColors = (rootColors: DefaultRootColors) => ({
    /**
 ...
 */
const getDefaultFaceColors = (rootColors: DefaultRootColors) => ({
    /**
 ...
 */
const getDefaultBoldColors = (rootColors: DefaultRootColors) => ({
    /**
 ...
 */
const getDefaultThinColors = (rootColors: DefaultRootColors) => ({
    /**
 ...
 */
const getDefaultEdgeColors = (rootColors: DefaultRootColors) => ({
    /**
 ...
 */
const getDefaultSoftColors = (rootColors: DefaultRootColors) => ({
    /**
...
export const getDefaultAllColors = () => {
    const commonColors = getDefaultCommonColors();
    const rootColors   = getDefaultRootColors(commonColors);
    return {
        // Constants:
        ...commonColors,
        ...rootColors,
        ...
        // Background colors:
        ...getDefaultBaseColors(rootColors),
        ...getDefaultMildColors(rootColors),
        
        
        
        // Foreground colors:
        ...getDefaultFlipColors(rootColors),
        ...getDefaultTextColors(rootColors),
        ...getDefaultFaceColors(rootColors),
        
        
        
        // Border colors:
        ...getDefaultBoldColors(rootColors),
        ...getDefaultThinColors(rootColors),
        ...getDefaultEdgeColors(rootColors),
        
        
        
        // Effect colors:
        ...getDefaultSoftColors(rootColors),
    };
};
export type DefaultAllColors = ReturnType<typeof getDefaultAllColors>
