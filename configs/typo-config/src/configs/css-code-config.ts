 ...
 * ```ts
 * const definition = codeConfigVarDefs.boxShadow; // Resolves to [[ "0px", "0px", "0px", "calc(", "var(--code-marginInlineStart)", " / 4)", "gray" ]]
 * ```
 * 
 * #### **Assigning a Custom Value (Setter)**
 * **Direct Assignment:**
 * ```ts
 * codeConfigVarDefs.fontWeightCustom = 900; // Generates "--code-fontWeightCustom: 900;"
 * ```
 * 
 * **Definition Assignment:**
 * ```ts
 * codeConfigVarDefs.boxShadow = [[
 *    "0px", "0px", "0px", "calc(", codeConfigVars.marginInlineStart, " / 4)", "gray"
 * ]]; // Generates "--code-boxShadow: 0px 0px 0px calc(var(--code-marginInlineStart) / 4) gray;"
 * ```
 * 
 ...
 * A variable can be removed using any of the following:
 * ```ts
 * delete codeConfigVarDefs.fontWeightCustom;
 * codeConfigVarDefs.fontWeightCustom = null;
 * codeConfigVarDefs.fontWeightCustom = undefined;
 * ```
 * 
 * #### **Definition Handling**
 * The **cssfn library** processes:
 ...
 * ```
 */
export const codeConfigVarDefs     = config[1];
