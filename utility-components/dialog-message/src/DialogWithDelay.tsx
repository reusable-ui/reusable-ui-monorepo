...
// react components:
export interface DialogWithDelayProps<TElement extends Element = HTMLElement, TData extends keyof any = any, TModalExpandedChangeEvent extends ModalExpandedChangeWithAnswerEvent<TData|'ok'> = ModalExpandedChangeWithAnswerEvent<TData|'ok'>>
    extends
        // bases:
...
const DialogWithDelay = <TElement extends Element = HTMLElement, TData extends keyof any = any, TModalExpandedChangeEvent extends ModalExpandedChangeWithAnswerEvent<TData|'ok'> = ModalExpandedChangeWithAnswerEvent<TData|'ok'>>(props: DialogWithDelayProps<TElement, TData, TModalExpandedChangeEvent>): JSX.Element|null => {
    // rest props:
    const {
        // components:
        modalComponent,
