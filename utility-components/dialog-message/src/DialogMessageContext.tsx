...
export interface DialogMessageApi {
    // dialogs:
    showDialog              <TData extends any = 'ok'>(dialogComponent           : React.ReactComponentElement<any, ModalBaseProps<Element, ModalExpandedChangeWithAnswerEvent<TData>>>): Promise<TData|undefined>
