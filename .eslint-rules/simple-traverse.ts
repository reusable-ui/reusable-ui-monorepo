/**
 * This file is adapted from the TypeScript-ESLint project:
 * https://github.com/typescript-eslint/typescript-eslint
 * 
 * Original source: packages/typescript-estree/src/simple-traverse.ts
 * 
 * License: MIT
 * Copyright (c) [original authors/contributors]
 */
