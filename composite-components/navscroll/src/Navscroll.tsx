...
// react components:
export interface NavscrollItemProps<TElement extends Element = HTMLElement>
    extends
        // bases:
...
export const NavscrollItem     = <TElement extends Element = HTMLElement>(props: NavscrollItemProps<TElement>): JSX.Element|null => {
    // rest props:
    const {
        // accessibilities:
        label,
...
export const NavscrollPrevItem = <TElement extends Element = HTMLElement>(props: NavscrollItemProps<TElement>): JSX.Element|null => {
    // jsx:
    return (
        <NavscrollItem<TElement>
            // other props:
            {...props}
...
export const NavscrollNextItem = <TElement extends Element = HTMLElement>(props: NavscrollItemProps<TElement>): JSX.Element|null => {
    // jsx:
    return (
        <NavscrollItem<TElement>
            // other props:
