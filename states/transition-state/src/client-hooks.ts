...
>(
    ...
    useTransitionStatePhaseEvents(transitionPhase, (changedTransitionPhase) => {
        triggerTransitionEvent?.({
            prevSettledState,
            settledState,
            changedTransitionPhase,
            props      : props      as TBehaviorProps,
            options    : options    as TBehaviorOptions,
            definition : definition as TBehaviorDefinition,
        } satisfies TriggerTransitionEventArgs<TState, TPhase, TBehaviorProps, TBehaviorOptions, TBehaviorDefinition>);
    });
