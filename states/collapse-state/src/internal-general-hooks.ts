...
export const useResolvedEffectiveExpandState = ({ declarativeState, props, options }: ResolveEffectiveStateArgs<boolean, CollapseStateProps<unknown>, CollapseStateOptions, CollapseStateDefinition>): boolean => {
