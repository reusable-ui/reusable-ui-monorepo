...
test.describe('useCollapseBehaviorState - controlled mode', () => {
    for (const { title, expanded : initialExpanded, updates } of [
        ...
        */
        ...
        {
            title    : 'Should be controlled to collapsed',
            expanded : false,
            updates  : [
                {
                    title                 : 'Should be collapsed and no animation',
        ...
        {
            title    : 'Should be controlled to expanded',
            expanded : true,
            updates  : [
                {
        ...
        {
            title    : 'Should be changed from collapsed to expanded',
            expanded : false,
            updates  : [
                {
                    title                 : 'Should be collapsed and no animation',
        ...
        {
            title    : 'Should be changed from expanded to collapsed',
            expanded : true,
            updates  : [
                {
                    title                 : 'Should be expanded and no animation',
        ...
        {
            title    : 'Should be changed from collapsed to expanded then collapsed',
            expanded : false,
            updates  : [
                {
                    title                 : 'Should be collapsed and no animation',
        ...
        {
            title    : 'Should be changed from expanded to collapsed then expanded',
            expanded : true,
            updates  : [
                {
                    title                 : 'Should be expanded and no animation',
    ...
    ] as CollapseStateControlledTestCase[]) {
        test(title, async ({ mount }) => {
            // States:
            let currentExpanded : boolean | undefined = initialExpanded;
            ...
            for (const { title, expanded, action, delay, expectedExpanded, expectedRunningExpand} of updates) {
