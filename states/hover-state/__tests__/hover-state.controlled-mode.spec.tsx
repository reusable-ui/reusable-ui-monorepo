...
test.describe('useHoverBehaviorState - controlled mode', () => {
    for (const { title, hovered : initialHovered, computedHover: initialComputedHover, updates } of [
        ...
        */
        {
            title         : 'Should be controlled to unhovered',
            hovered       : false,
            updates       : [
                {
        ...
        {
            title         : 'Should be controlled to hovered',
            hovered       : true,
            updates       : [
                {
        ...
        {
            title         : 'Should be changed from unhovered to hovered',
            hovered       : false,
            updates       : [
                {
                    title                : 'Should be unhovered and no animation',
        ...
        {
            title         : 'Should be changed from hovered to unhovered',
            hovered       : true,
            updates       : [
                {
                    title                : 'Should be hovered and no animation',
        ...
        {
            title         : 'Should be changed from unhovered to hovered then unhovered',
            hovered       : false,
            updates       : [
                {
                    title                : 'Should be unhovered and no animation',
        ...
        {
            title         : 'Should be changed from hovered to unhovered then hovered',
            hovered       : true,
            updates       : [
                {
                    title                : 'Should be hovered and no animation',
        ...
        test(title, async ({ mount }) => {
            ...
            for (const { title, hovered, computedHover, delay, expectedHover, expectedRunningHover} of updates) {
                ...
                if (expectedHover !== undefined) {
                    expect(box).toHaveAttribute('data-state', expectedHover);
                } // if
