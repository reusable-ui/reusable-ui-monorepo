...
import { enforceVariableConventions, enforceCssVarsFunctionUsage, enforceCssConfigFunctionUsage, noForeignCode as noForeignCodeInCssVars, requireSideeffectsForRegistry, migrateCssVarsTupleStyle, enforceVarOptionsPair, enforceIndexVarOptionsReexport } from './.eslint-rules/css-variables.js'
...
import { noForeignCodeInTypes, banVarianceAnnotations, banRedundantJsdocTypes, banJsdocDash } from './.eslint-rules/types.js'
...
export default defineConfig(
    ...
    // 5. Project-specific configs:
    {
        ...
        plugins: {
            ...
            'css-variables': {
                rules: {
                    ...
                    'enforce-var-options-pair'         : enforceVarOptionsPair         as unknown as Rule.RuleModule,
                    'enforce-index-var-options-reexport' : enforceIndexVarOptionsReexport as unknown as Rule.RuleModule,
                },
            },
            'css-prefix-default': {
                rules: {
            ...
            'react-hooks': {
                rules: {
                    ...
                    'enforce-client-hook-modules'      : enforceClientHookModules      as unknown as Rule.RuleModule,
        ...
        rules: {
            ...
            'css-variables/enforce-var-options-pair'         : 'error',
            'css-variables/enforce-index-var-options-reexport' : 'error',
