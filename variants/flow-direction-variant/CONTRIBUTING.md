# Contributing to @reusable-ui/flow-direction-variant ✍️  
...
cd variants/flow-direction-variant
npm install
npm run dev
```
...
Thanks for helping make **@reusable-ui/flow-direction-variant** better! 🚀  
