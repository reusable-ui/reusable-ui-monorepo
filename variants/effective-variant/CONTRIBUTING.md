# Contributing to @reusable-ui/effective-variant ✍️  
...
### 1️⃣ **Report Issues**  
- Found a bug or have a variant request? Open an issue [here](https://github.com/reusable-ui/reusable-ui-monorepo/issues).  
- Provide **clear reproduction steps** and expected behavior.  

### 2️⃣ **Submit a Pull Request (PR)**  
- **Fork the repository** and clone it locally.  
- Create a new **branch** (`variant-xyz` or `fix-xyz`).  
...
Thanks for helping make **@reusable-ui/effective-variant** better! 🚀  
