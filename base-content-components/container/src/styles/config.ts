...
export const [containers, containerValues, cssContainerConfig] = cssConfig(() => {
    const bases = {
        ...
        // spacings:
        paddingInlineXs   : '12px'                  as CssKnownProps['paddingInline'],
        paddingBlockXs    :  '9px'                  as CssKnownProps['paddingBlock' ],
    ...
    const defaults = {
        // spacings:
        paddingInline     : bases.paddingInlineXs   as CssKnownProps['paddingInline'],
        paddingBlock      : bases.paddingBlockXs    as CssKnownProps['paddingBlock' ],
    };
